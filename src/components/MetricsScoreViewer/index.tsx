...
export const MetricsScoreViewer: React.FC<MetricsScoreViewerProps> = ({
    cik,
    displayDetails = true
}) => {
            ...
            {displayDetails && (
                <>
                    <div className="flex-none align-content-center">
                        {chartData.labels.map((k: string, i: number) => (
                            <div key={k} className="flex m-4">
